    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <button
                    onClick={() => navigate('/accountant-dashboard/reports/fees/create')}
                        ...
                        {fees.map((fee) => (
                            <tr key={fee._id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <button
                                        onClick={() => navigate(`/accountant-dashboard/reports/fees/${fee._id}`)}
                                    ...
                                    <button
                                        onClick={() => navigate(`/accountant-dashboard/reports/fees/edit/${fee._id}`)}
